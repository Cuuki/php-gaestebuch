module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      material: {
        options: {
          ...
          sourceMap: true,
          sourceMapRootpath: "/",
          sourceMapFilename: "root/css/material.css.map",
          sourceMapURL: "material.css.map"
        },
        files: {
          "root/css/material.css": "less/material.less",
        }
      },
      materialwfont: {
        options: {
          ...
          sourceMap: true,
          sourceMapRootpath: "/",
          sourceMapFilename: "root/css/material-wfont.css.map",
          sourceMapURL: "material-wfont.css.map",
          outputSourceFiles: true
        },
        files: {
          "root/css/material-wfont.css": "less/material-wfont.less",
        }
      },
      ripples: {
        options: {
          ...
          sourceMap: true,
          sourceMapRootpath: "/",
          sourceMapFilename: "root/css/ripples.css.map",
          sourceMapURL: "ripples.css.map",
          outputSourceFiles: true
        },
        files: {
          "root/css/ripples.css": "less/ripples.less",
        }
      }
    },
    ...
    autoprefixer: {
      ...
      material: {
        files: {
          "root/css/material.css": "root/css/material.css",
          "root/css/material.min.css": "root/css/material.min.css"
        }
      },
      materialwfont: {
        files: {
          "root/css/material-wfont.css": "root/css/material-wfont.css",
          "root/css/material-wfont.min.css": "root/css/material-wfont.min.css"
        }
      },
      ripples: {
        files: {
          "root/css/ripples.css": "root/css/ripples.css",
          "root/css/ripples.min.css": "root/css/ripples.min.css"
        }
      }
    },
    ...
    csswring: {
      material: {
        src: "root/css/material.css",
        dest: "root/css/material.min.css"
      },
      materialwfont: {
        src: "root/css/material-wfont.css",
        dest: "root/css/material-wfont.min.css"
      },
      ripples: {
        src: "root/css/ripples.css",
        dest: "root/css/ripples.min.css"
      }
    },

    // Copy .js to root/js/ folder
    copy: {
      material: {
        src: "scripts/material.js",
        dest: "root/js/material.js"
      },
      ripples: {
        src: "scripts/ripples.js",
        dest: "root/js/ripples.js"
      },
      fonts: {
        expand: true,
        cwd: "fonts/",
    ...
    uglify: {
      ...
      material: {
        files: {
          "root/js/material.min.js": "root/js/material.js"
        }
      },
      ripples: {
        files: {
          "root/js/ripples.min.js": "root/js/ripples.js"
        }
      }
    },
